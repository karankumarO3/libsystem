    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Add New Address</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="course_add.php">
                <div class="form-group">
                    <label for="code" class="col-sm-3 control-label">Area Code</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="course_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_code" class="col-sm-3 control-label">New Code</label>
                ...
                <div class="form-group">
                    <label for="edit_title" class="col-sm-3 control-label">New Adress</label>
